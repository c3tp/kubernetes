...
func generateCredentials(svcNamespace, name, svcName, localDNSZoneName, serverCredName string, ips, hostnames []string, enableHTTPBasicAuth bool, enableTokenAuth bool, enableWebhookAuth bool, webhookURL string, webhookCA string, webhookCert string, webhookKey string, dryRun bool) (*credentials, error) {
